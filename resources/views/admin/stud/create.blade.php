...
<section class="content">
    <div class="container-fluid">
        <div class="card card-primary">
            <form action={{route("stud.store")}} method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                @if ($errors->any())
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name = "fullname" id="input_title" value="{{old("fullname")}}" placeholder="Полное имя">
                </div>
                <div class="form-group">
                    <label for="input_status">Статус</label>
                    <input type="text" class="form-control" name = "status" value="{{old("status")}}" id="input_status" placeholder="Статус">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea id="input_description" name="description">{{old("description")}}</textarea>
                </div>
                <div class="form-group">
                  <label for="link_telegram">Ссылка на Telegram (не обезательное)</label>
                  <input type="text" class="form-control" placeholder="Ссылка на Telegram" name = "telegram" value="{{old("telegram")}}" id="link_telegram" >
                </div>
                <div class="form-group">
                  <label for="LinkPhotos">Ссылка на Instagram (не обезательное)</label>
                  <input type="text" class="form-control" placeholder="Ссылка на Instagram" name = "instagram" value="{{old("instagram")}}" id="link_instagram">
                </div>
                <div class="form-group">
                  <label for="LinkVideos">Ссылка на Twitter (не обезательное)</label>
                  <input type="text" class="form-control" name = "twitter" id="link_twitter" value="{{old("twitter")}}"
