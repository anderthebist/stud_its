    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                <form method="POST" action = {{route("open_air.update",$open_air["id"])}} enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="card-body">
                        ...
                        @if ($type === "IMAGE")
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="file_input">{{$open_air->path}}</label>
                                </div>
                        ...
                        @elseif($type === "VIDEO")
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name = "path" id="link_video" 
                                placeholder="Ссылка на видео" value = {{$open_air->path}}>
                            </div>
                        @endif
                    </div>
                  <!-- /.card-body -->
